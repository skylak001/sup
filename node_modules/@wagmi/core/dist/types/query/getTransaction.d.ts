...
export declare function getTransactionQueryOptions<config extends Config, chainId extends config['chains'][number]['id']>(config: config, options?: GetTransactionOptions<config, chainId>): {
    ...
    }) => Promise<(import("../types/chain.js").SelectChains<config, chainId> extends infer T_2 extends readonly import("viem").Chain[] ? { [key_1 in keyof T_2]: import("viem/chains").UnionLooseOmit<import("viem").ExtractChainFormatterReturnType<import("../types/utils.js").IsNarrowable<import("../types/chain.js").SelectChains<config, chainId>[key_1], import("viem").Chain> extends true ? import("../types/chain.js").SelectChains<config, chainId>[key_1] : undefined, "transaction", import("viem").Transaction>, "blockHash" | "blockNumber" | "transactionIndex"> & { [_K in ("blockHash" | "blockNumber" | "transactionIndex") & import("viem").ExtractChainFormatterExclude<import("../types/utils.js").IsNarrowable<import("../types/chain.js").SelectChains<config, chainId>[key_1], import("viem").Chain> extends true ? import("../types/chain.js").SelectChains<config, chainId>[key_1] : undefined, "transaction">]: never; } & Pick<import("viem").Transaction<bigint, number, false>, "blockHash" | "blockNumber" | "transactionIndex"> & {
        chainId: import("../types/chain.js").SelectChains<config, chainId>[key_1]["id"];
    }; } : never)[number] extends infer T ? { [key in keyof T]: (import("../types/chain.js").SelectChains<config, chainId> extends infer T_1 extends readonly import("viem").Chain[] ? { [key_1 in keyof T_1]: import("viem/chains").UnionLooseOmit<import("viem").ExtractChainFormatterReturnType<import("../types/utils.js").IsNarrowable<import("../types/chain.js").SelectChains<config, chainId>[key_1], import("viem").Chain> extends true ? import("../types/chain.js").SelectChains<config, chainId>[key_1] : undefined, "transaction", import("viem").Transaction>, "blockHash" | "blockNumber" | "transactionIndex"> & { [_K in ("blockHash" | "blockNumber" | "transactionIndex") & import("viem").ExtractChainFormatterExclude<import("../types/utils.js").IsNarrowable<import("../types/chain.js").SelectChains<config, chainId>[key_1], import("viem").Chain> extends true ? import("../types/chain.js").SelectChains<config, chainId>[key_1] : undefined, "transaction">]: never; } & Pick<import("viem").Transaction<bigint, number, false>, "blockHash" | "blockNumber" | "transactionIndex"> & {
        chainId: import("../types/chain.js").SelectChains<config, chainId>[key_1]["id"];
