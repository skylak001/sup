...
let W3mAccountSettingsView = class W3mAccountSettingsView extends LitElement {
    ...
    togglePreferredAccountBtnTemplate() {
        ...
        const text = preferredAccountType === W3mFrameRpcConstants.ACCOUNT_TYPES.SMART_ACCOUNT
            ? 'Switch to your EOA'
    ...
    async changePreferredAccountType() {
        ...
        const preferredAccountType = W3mFrameHelpers.getPreferredAccountType();
        const accountTypeTarget = preferredAccountType === W3mFrameRpcConstants.ACCOUNT_TYPES.SMART_ACCOUNT ||
            !smartAccountEnabled
